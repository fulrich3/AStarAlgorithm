...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Node__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Node */ \"./src/classes/Node.ts\");\n/* harmony import */ var _Client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Client */ \"./src/classes/Client.ts\");\n\r\n\r\nvar Map = /** @class */ (function () {\r\n    function Map(config) {\r\n        this.grid = [];\r\n        this.width = 20;\r\n        this.height = 20;\r\n        this.cellSize = 20;\r\n        this.colorStroke = \"#111\";\r\n        this.colorStrokeHover = \"#666\";\r\n        this.colorFillNormal = \"#fff\";\r\n        this.colorFillSolid = \"#161616\";\r\n        if (config.width)\r\n            this.width = Math.floor(config.width);\r\n        if (config.height)\r\n            this.height = Math.floor(config.height);\r\n        if (config.drawOptions) {\r\n            var drawConfig = config.drawOptions;\r\n            if (drawConfig.cellSize) {\r\n                this.cellSize = Math.floor(drawConfig.cellSize);\r\n            }\r\n        }\r\n        // Set array size\r\n        for (var y = 0; y < this.height; y++) {\r\n            this.grid.push([]);\r\n        }\r\n        // Add nodes to grid\r\n        for (var x = 0; x < this.width; x++) {\r\n            for (var y = 0; y < this.height; y++) {\r\n                var walkable = true;\r\n                var map = this;\r\n                this.grid[y][x] = new _Node__WEBPACK_IMPORTED_MODULE_0__[\"default\"](map, x, y, walkable);\r\n            }\r\n        }\r\n        // Set client\r\n        this.client = new _Client__WEBPACK_IMPORTED_MODULE_1__[\"default\"](this);\r\n    }\r\n    Map.prototype.appendHtmlCanvas = function (tagId) {\r\n        this.canvas = document.createElement(\"canvas\");\r\n        this.ctx = this.canvas.getContext(\"2d\");\r\n        this.canvas.style.backgroundColor = \"gray\";\r\n        this.canvas.width = this.width * this.cellSize;\r\n        this.canvas.height = this.height * this.cellSize;\r\n        if (tagId == undefined) {\r\n            document.body.appendChild(this.canvas);\r\n        }\r\n        else {\r\n            document.getElementById(tagId).appendChild(this.canvas);\r\n        }\r\n        this.drawHtmlCanvas();\r\n    };\r\n    /*\r\n    update(){\r\n        console.log(\"update\");\r\n        this.drawHtmlCanvas();\r\n    }\r\n    */\r\n    Map.prototype.drawHtmlCanvas = function () {\r\n        this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height);\r\n        for (var y = 0; y < this.height; y++) {\r\n            for (var x = 0; x < this.width; x++) {\r\n                var currentNode = this.grid[y][x];\r\n                currentNode.draw();\r\n            }\r\n        }\r\n        console.log(\"done\");\r\n    };\r\n    return Map;\r\n}());\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (Map);\r\n\n\n//# sourceURL=webpack:///./src/classes/Map.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.scss */ \"./src/style.scss\");\n/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _classes_Map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classes/Map */ \"./src/classes/Map.ts\");\n\r\n\r\n\r\n\r\nvar mapConfig = {\r\n    width: 20,\r\n    height: 20,\r\n    draw: true,\r\n    drawOptions: {\r\n        cellSize: 40,\r\n    }\r\n}\r\n\r\nfunction init(){\r\n    var map = new _classes_Map__WEBPACK_IMPORTED_MODULE_1__[\"default\"](mapConfig);\r\n    map.appendHtmlCanvas();\r\n}\r\n\r\ndocument.addEventListener(\"DOMContentLoaded\", init, false);\n\n//# sourceURL=webpack:///./src/index.js?");
